...
public class UserController{
	...
	public List<User>allBookingById(@PathVariable int id){
		
	return	bookInfoService.BookingInfoByIdUser(id);
	...
	public String updateUserMobileNumber
(@PathVariable String mobileNumber,@PathVariable int id) {
